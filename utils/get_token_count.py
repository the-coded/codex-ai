"""
Token counting utilities for Codex-AI.

This module provides accurate token counting using Anthropic's official API
with intelligent fallback mechanisms for offline scenarios.
"""
