...
OUTPUT_FORMATS = {
    ...
    "CSV": {
        ...
        "use_cases": ["data analysis", "spreadsheets", "time tracking"],
        "pretty": False
    }
}
...
REPORT_TEMPLATES = {
    ...
    "TIMETRACK": {
        ...
        "summary": "## Summary\n\n- 📝 **Total Commits**: {total_commits}\n- ⏱️ **Total Hours**: {total_hours:.2f}h\n- 📈 **Average per Commit**: {avg_hours:.2f}h\n\n",
        "section": "## {section_title}\n\n{content}\n\n",
        "commit_item": "- **{hash}** ({date}): {message} - {hours:.2f}h\n",
